...
running command...
$ bwe (--version)
backlog-wiki-exporter/0.0.4 darwin-arm64 node-v20.18.1
$ bwe --help [COMMAND]
USAGE
  $ bwe COMMAND
...
...
_See code: [src/commands/download/index.ts](https://github.com/workspace/backlog-wiki-exporter/blob/v0.0.4/src/commands/download/index.ts)_
...
_See code: [src/commands/hello/index.ts](https://github.com/workspace/backlog-wiki-exporter/blob/v0.0.4/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/workspace/backlog-wiki-exporter/blob/v0.0.4/src/commands/hello/world.ts)_
